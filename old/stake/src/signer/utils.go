...
/*
All credits for this go to https://github.com/miguelmota/go-solidity-sha3
The only reason why I didn't use that library directly was due to how go-ethereum is vendored
*/
